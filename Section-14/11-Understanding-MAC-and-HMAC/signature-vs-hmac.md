...
Can we call a **MAC (Message Authentication Code)** or the **tag** it produces a _digital signature_ of the message?
...
In **many real-world systems**, HMACs are used for _message signing_ — for example:
...
In these cases, the term _"signature"_ is used **informally**, meaning:

> _“We’re attaching a cryptographic tag to verify the data hasn’t been tampered with.”_
